...
const SubNav = ({...props}) => {
    ...
    return (
        <div className={`transition-all rounded-lg relative text-black/30 flex items-start gap-2 cursor-pointer ${isOpen || active ? 'bg-primary-blue-500 text-white rounded-r-none ' : ''}`}>
