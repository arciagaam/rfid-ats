...
const SubNav = ({...props}) => {
    ...
    return (
        <div className={`transition-all rounded-lg relative text-primary-blue-900/50 hover:bg-primary-blue-500 flex items-start gap-2 cursor-pointer ${isOpen || active ? 'bg-primary-blue-500 text-white rounded-r-none ' : ''}`}>
