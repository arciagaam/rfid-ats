            ...
            <Navbar department={department}>
                ...
                <div className='flex flex-col w-full h-full gap-3'>
                    ...
                    <SubNav
                        ...
                        icon={{
                            active: <MdAnalytics size={25} />,
                            inactive: <MdOutlineAnalytics size={25} />,
                        }}
                        active={location.pathname.includes('admin/accomplishment-reports')}>
                        <Link
                            to='accomplishment-reports/regular'
                            className='hover:bg-primary-blue-500 hover:text-white py-5 px-5 bg-white'>
                            Regular Faculty
                        </Link>
                        <Link
                            to='accomplishment-reports/part-time'
                            className='hover:bg-primary-blue-500 hover:text-white py-5 px-5 bg-white'>
                            Part Time Faculty
                        </Link>
                    </SubNav>
