...
const AccomplishmentReportForm = ({ ...props }) => {
    ...
    const [storeAccomplishmentReport, { isLoading: loadingRegister }] =
        useStoreAccomplishmentReportMutation()

    const { userInfo } = useSelector((state: RootState) => state.auth)
    const { refetch: refetchUser } = useGetProfileQuery(userInfo!._id as string)
